...
If Errorlevel 2 echo busybox ping -c 1 -w 1800 192.168.41.2 >> check_1860_state.sh
...
If Errorlevel 4 echo busybox ping -c 1 -w 1800 192.168.41.2 >> check_1860_state.sh
...
If Errorlevel 3 echo busybox ping -c 1 -w 1800 192.168.41.2 >> check_1860_state.sh
